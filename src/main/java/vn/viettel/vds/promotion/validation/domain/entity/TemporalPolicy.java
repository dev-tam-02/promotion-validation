...
public class TemporalPolicy {
    ...
    public List<String> getRdate() { return rdate; }
    public void setRdate(List<String> rdate) { this.rdate = rdate; }

    public String getExrule() { return exrule; }
    public void setExrule(String exrule) { this.exrule = exrule; }

    public List<String> getExdate() { return exdate; }
    public void setExdate(List<String> exdate) { this.exdate = exdate; }

    public List<TimeOfDayWindow> getTimeOfDayWindows() { return timeOfDayWindows; }
    public void setTimeOfDayWindows(List<TimeOfDayWindow> timeOfDayWindows) { this.timeOfDayWindows = timeOfDayWindows; }
