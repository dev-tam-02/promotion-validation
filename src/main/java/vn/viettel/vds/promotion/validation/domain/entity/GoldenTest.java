...
public class GoldenTest {
    ...
    public static class TestExpectation {
        ...
        public void setReasonCodes(java.util.List<String> reasonCodes) { this.reasonCodes = reasonCodes; }
    }
    ...
    public TestExpectation getExpect() { return expect; }
    public void setExpect(TestExpectation expect) { this.expect = expect; }

    public Instant getLastRun() { return lastRun; }
    public void setLastRun(Instant lastRun) { this.lastRun = lastRun; }

    public TestResult getLastResult() { return lastResult; }
    public void setLastResult(TestResult lastResult) { this.lastResult = lastResult; }
}