...
public class PublishRuleRequest {
    ...
    public void setOptions(PublishOptions options) {
    ...
    public static class PublishOptions {
        ...
        // Getters and setters
        public Integer getCompilationTimeout() {
            return compilationTimeout;
        }

        public void setCompilationTimeout(Integer compilationTimeout) {
        ...
        public void setVerificationTimeout(Integer verificationTimeout) {
