...
public class CloneRuleRequest {
    ...
    @Schema(description = "New rule code", example = "WEEKEND_VIP_500K_V2", required = true)
    ...
    @Schema(description = "New rule name", example = "Weekend VIP ≥500k promotion V2", required = true)
