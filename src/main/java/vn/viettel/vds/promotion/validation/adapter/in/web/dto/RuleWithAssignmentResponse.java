...
public class RuleWithAssignmentResponse {
    ...
    public static class AssignmentDetails {
        ...
        public String getStickyKeyStrategy() { return stickyKeyStrategy; }
        public void setStickyKeyStrategy(String stickyKeyStrategy) { this.stickyKeyStrategy = stickyKeyStrategy; }
    ...
    // Getters and setters
    public RuleResponse getRule() { return rule; }
    public void setRule(RuleResponse rule) { this.rule = rule; }

    public AssignmentDetails getAssignment() { return assignment; }
    public void setAssignment(AssignmentDetails assignment) { this.assignment = assignment; }
}